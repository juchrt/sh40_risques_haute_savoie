...
map.getView().fit([621021.209324, 5707933.164146, 840111.242893, 5886445.122656], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">haute_savoie_test_hydro_reliefs</h2>';
        return titleElement;
    })(),
